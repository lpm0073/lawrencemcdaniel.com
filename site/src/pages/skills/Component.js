...
const Skills = (props) => {
    ...
    return(
        <React.Fragment>
            ...
            <div className="site-page skills-page">
                <RenderPageTitle theme="light" icon="fa-book" title="HARD" boxed_title="SKILLS" />

                <div className="row mt-5 mb-5 ml-0 mr-0">
                    <SkillColumn pct="100" title="Web" icon="fa-code" description="Complete professional web sites and web apps using Django, ReactJS, Redux, Angular, and WordPress" />
                    ...
                    <SkillColumn pct="100" title="Cloud" icon="fa-cloud" description="Server migrations, and consultation on cloud infrastructure planning to minimize costs while maximizing security and performance." />
                    ...
                    <SkillColumn pct="100" title="DevOps" icon="fa-server" description="Create and maintain continuous integration strategies using GitHub, AWS Boto3, Jenkins, Chef, Puppet or Ansible." />
                ...
                <div className="row mt-5 mb-5">
                    <div className="col-lg-6 col-md-12">
                        <SkillBar pct="100" description="Django, React, Redux, Angular, Ionic, WordPress" />
                        <SkillBar pct="100" description="Bootstrap, D3, Underscore.js" />
