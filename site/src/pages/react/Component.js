                ...
                <div className="row mt-lg-5 pl-2">
                    ...
                    <div className="col-lg-8 col-md-12">
                        <div className="text-justify">
                            ...
                            <p><span className="react-page-leader">Progressive Web App (PWA)</span>: This site is fully-functional and performant regardless of Internet quality, even if there's no Internet service at all. It's observably performant because all of the site assets are precached and served locally. It's more resilient because it works fine even with sparse or non-existent Internet service.</p>
                            <p>Part of this is made possible simply because the World Wide Web Consortium implemented a set of standards for implementing a local browser javascript-based <a href="https://developers.google.com/web/fundamentals/primers/service-workers" target="_blank">service worker</a>. A service worker is a script that your browser runs in the background, separate from a web page, opening the door to features that don't need a web page or user interaction. They manage the client side of synchronizing web apps; topics like precaching, runtime caching, request routing, and background code and static asset synronization. I'm using <a href="https://developers.google.com/web/tools/workbox" target="_blank">Google Workbox</a>, a library that bakes in a set of best practices and removes all of the heavy lifting involved in working with service workers.</p>

                            <p>In my case converting my standard React app into a PWA involved modifying/creating the following:</p>
                            <ul>
                                <li><a href="https://github.com/lpm0073/lawrencemcdaniel.com/blob/master/site/src/index.js" target="_blank">index.js</a></li>
                                <li><a href="https://github.com/lpm0073/lawrencemcdaniel.com/blob/master/site/src/App.js" target="_blank">App.js</a></li>
                                <li><a href="https://github.com/lpm0073/lawrencemcdaniel.com/blob/master/site/src/service-worker.js" target="_blank">service-worker.js - scaffolded with create-react-app.</a></li>
                                <li><a href="https://github.com/lpm0073/lawrencemcdaniel.com/blob/master/site/src/serviceWorkerRegistration.js" target="_blank">serviceWorkerRegistration.js - Google Workbox wrapper</a></li>
                                <li><a href="https://github.com/lpm0073/lawrencemcdaniel.com/tree/master/site/src/components/appUpdate" target="_blank">custom appUpdate component: for automatic update alerts.</a></li>
                            </ul>
