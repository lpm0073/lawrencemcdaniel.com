                ...
                <div className="row mt-5">
                    ...
                    <div className="col-lg-8 col-md-12 ml-5">
                        <div className="text-justify">
                            ...
                            <p>Thousands of organizations around the world have used my Open edX® blog articles to turn their online education vision into reality. In the spirit of community and as a fellow open source code enthusiast I make a diligent effort to publish my Open edX® know-how in order to maximize the reach of this remarkable platform. As of early 2021 my articles, <a href="https://blog.lawrencemcdaniel.com/open-edx-installation/" target="_blank" rel="noopener noreferrer">Open edX Step-By-Step Production Installation Guide</a>, <a href="https://blog.lawrencemcdaniel.com/scaling-open-edx/" target="_blank" rel="noopener noreferrer">Scaling Open edX</a>, <a href="https://blog.lawrencemcdaniel.com/open-edx-custom-theming-tutorial/" target="_blank" rel="noopener noreferrer">Open edX Custom Theming Tutorial</a>, and <a href="https://blog.lawrencemcdaniel.com/open-edx-configuration-tutorial/" target="_blank" rel="noopener noreferrer">Open edX Configuration Tutorial</a> have been viewed more than fifty thousand times.</p>
                            <h4>Installation</h4>
