...
export const URL_API_SPECIALTIES =
  backendUrl + "posts?categories=43&_embed&per_page=100";
export const URL_API_PORTFOLIO =
  backendUrl + "posts?categories=47&_embed&per_page=100";
export const URL_API_EDUCATION =
  backendUrl + "posts?categories=44&_embed&per_page=100";
...
export const URL_API_CLIENTS =
  backendUrl + "posts?categories=46&_embed&per_page=100";
