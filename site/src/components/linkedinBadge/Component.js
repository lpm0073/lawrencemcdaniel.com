        ...
        <div key="linkedin-badge" className="LI-badge-container text-center">
            <div className="">
                ...
                <div className="mt-5">
                    ...
                    <div className="LI-title"><span role="img" aria-label="Close">📡</span> Full Stack Developer</div>
                </div>
            </div>
            <div className="">
            ...
            <div className="mt-4">
                <a className="btn btn-primary" role="button" href="https://www.linkedin.com/in/lawrencemcdaniel?trk=profile-badge-cta">View profile</a>
                <div className="pb-3 mt-3">
                    <img src="https://cdn.lawrencemcdaniel.com/wp-content/uploads/2020/05/15213433/logo_linkedin_flat_white_93x21.png" 
                         alt="LinkedIn" 
                         className="LI-icon"
                         loading="lazy"/>
                </div>
