...
export const gsdHowToInstallOpenEdx = {
  ...
  creator: {
    '@id':
      'https://blog.lawrencemcdaniel.com/#/schema/person/5cde4301ca9b99abf63feb5401a7a7b1',
  },
  ...
  step: [
    {
      ...
      itemListElement: [
        ...
        {
          '@type': 'HowToDirection',
          name: 'Review Instance Prior to Launch',
