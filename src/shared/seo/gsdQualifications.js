...
const EducationalOccupationalCredential = (courseName, description, url, providerName, providerUrl, dateCreated, is_university) => {
  return {
...
export const gsdQualifications = (courses) => {
  ...
  return [
  EducationalOccupationalCredentialUNT,
    ...certificates
]
}
